...
(* OASIS_START *)
(* DO NOT EDIT (digest: 294a53b14f487e537514bda0c45f5414) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("extlib", None)];
     ...
     oasis_digest =
       Some "6\240\165\247\168L\159\149i\206\243\168\176\021P\233";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
