...
let cbproceed = foreign "GRBcbproceed" (ptr void @-> returning int)
let cbget = foreign "GRBcbget" (ptr void @-> int @-> int @-> ptr void @-> returning int)
let cbsetintparam = foreign "GRBcbsetintparam" (ptr void @-> string @-> int @-> returning int)
let cbsetdblparam = foreign "GRBcbsetdblparam" (ptr void @-> string @-> double @-> returning int)
let cbsetstrparam = foreign "GRBcbsetstrparam" (ptr void @-> string @-> string @-> returning int)
...
let getgenconstrNorm = foreign "GRBgetgenconstrNorm" (ptr grb_Model @-> int @-> ptr int @-> ptr int @-> ptr int @-> ptr double @-> returning int)
let getgenconstrNL = foreign "GRBgetgenconstrNL" (ptr grb_Model @-> int @-> ptr int @-> ptr int @-> ptr int @-> ptr double @-> ptr int @-> returning int)
...
let getgenconstrLogistic = foreign "GRBgetgenconstrLogistic" (ptr grb_Model @-> int @-> ptr int @-> ptr int @-> returning int)
...
let copymodeltoenv = foreign "GRBcopymodeltoenv" (ptr grb_Model @-> ptr grb_Env @-> ptr (ptr grb_Model) @-> returning int)
...
let addgenconstrLogistic = foreign "GRBaddgenconstrLogistic" (ptr grb_Model @-> string @-> int @-> int @-> string @-> returning int)
...
let singularvectors = foreign "GRBsingularvectors" (ptr grb_Model @-> ptr double @-> ptr double @-> returning int)
...
let loadenvinternal = foreign "GRBloadenvinternal" (ptr (ptr grb_Env) @-> string @-> int @-> int @-> int @-> returning int)
let emptyenvinternal = foreign "GRBemptyenvinternal" (ptr (ptr grb_Env) @-> int @-> int @-> int @-> returning int)
...
let discardtuneenvs = foreign "GRBdiscardtuneenvs" (ptr grb_Env @-> returning void)
...
let getdistro = foreign "GRBgetdistro" (string @-> returning void)
let getwlstokenlifespan = foreign "GRBgetwlstokenlifespan" (ptr grb_Env @-> ptr int @-> returning int)
let sortIDi = foreign "GRBsortIDi" (int @-> ptr int @-> ptr double @-> returning void)
...
let tunemodels = foreign "GRBtunemodels" (ptr grb_Env @-> int @-> ptr (ptr grb_Model) @-> returning int)
